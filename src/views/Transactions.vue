    ...
    <div>
      <div class="flex gap-12">
        ...
        <button
          ...
          type="button"
          class="h-12 focus:outline-none text-white bg-[#FFA800] hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
        >
          Add
        </button>
      </div>
